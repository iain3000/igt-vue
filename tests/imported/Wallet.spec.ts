// import {IgtWallet} from "incremental-game-template/lib/ig-template/features/wallet/IgtWallet";
import { IgtWalletStore as IgtWallet } from "@/stores";
import {CurrencyType} from "incremental-game-template/lib/ig-template/features/wallet/CurrencyType";
import {Currency} from "incremental-game-template/lib/ig-template/features/wallet/Currency";
import {WalletSaveData} from "incremental-game-template/lib/ig-template/features/wallet/WalletSaveData";
...
describe('Wallet', () => {
    ...
    test('supported currencies', () => {
        ...
        // Assert
        // expect(moneyWallet._supportedCurrencies.length).toBe(2);
