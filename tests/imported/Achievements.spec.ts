// import {IgtAchievements} from "incremental-game-template/lib/ig-template/features/achievements/IgtAchievements";
import { IgtAchievementStore as IgtAchievements  } from "@/stores";
import {Achievement} from "incremental-game-template/lib/ig-template/features/achievements/Achievement";
import {AchievementId} from "incremental-game-template/lib/ig-template/features/achievements/AchievementId";
import {NoRequirement} from "incremental-game-template/lib/ig-template/tools/requirements/NoRequirement";
import {ImpossibleRequirement} from "incremental-game-template/lib/ig-template/tools/requirements/ImpossibleRequirement";
import {CustomAchievement} from "incremental-game-template/lib/ig-template/features/achievements/CustomAchievement";
import {Progress} from "incremental-game-template/lib/ig-template/tools/requirements/Progress";
...
import {ArrayStatisticRequirement} from "incremental-game-template/lib/ig-template/features/statistics/requirements/ArrayStatisticRequirement";
...
describe('Achievements', () => {
    ...
    test('test unlock', () => {
        ...
        useAchievementStore().$onAction(({ after }) => {
            after((ach) => {
                expect(ach).toEqual(achievement)
            })
        })
