  ...
  <div class="bg-gray-600 p-4 m-2 shadow-lg text-white">
    <div class="flex flex-col">
      ...
      <div class="flex flex-row justify-start">
        <span class="mr-12">{{ $filters.dateFormat(event.startTime) }}</span>
        <span>{{ $filters.dateFormat(event.endTime) }}</span>
      </div>
...
<script>
import {DateHelper, SpecialEvent, SpecialEventDateState} from "@/ig-template";
